package examples.by.yurachel.blinov.patterns.structural_patterns.bridge.example;

import examples.by.yurachel.blinov.patterns.structural_patterns.bridge.example.account.impl.CreditAccount;
import examples.by.yurachel.blinov.patterns.structural_patterns.bridge.example.account.impl.DepositAccount;
import examples.by.yurachel.blinov.patterns.structural_patterns.bridge.example.action.Action;
import examples.by.yurachel.blinov.patterns.structural_patterns.bridge.example.action.impl.RegularAction;
import examples.by.yurachel.blinov.patterns.structural_patterns.bridge.example.action.impl.UrgentAction;
